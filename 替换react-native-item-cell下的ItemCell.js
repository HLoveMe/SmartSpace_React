...
class ItemCell extends React.Component {
  ...
  render () {
    ...
    return (
        <TouchableHighlight {...touchableProps} onPress={()=>{
            ...
            <View style={styles.rightContainer}>
              <View style={styles.textIconContainer}>
                ...
                <View style={styles.disclosureContainer}>
                  {
                    this.props.assistComponent ? this.props.assistComponent() : this._renderDisclosureIndicator()
                  }
                </View>
              </View>
              <View style={[styles.border,this.props.border]} />
            </View>
          </View>
        </TouchableHighlight>
    )
...
ItemCell.propTypes = {
  ...
  border:PropTypes.object,//应用cell下的分割线
  assistComponent:PropTypes.func,
  data:PropTypes.any,
